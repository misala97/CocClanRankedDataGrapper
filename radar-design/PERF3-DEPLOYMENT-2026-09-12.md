...
## Owner-requested design gallery carry
Uploaded three fictional mockups and gallery to personal_apps/static/radar/design-reference/ on VPS. Added radar-design-reference-link banner to live templates/radar/hub.html and restarted personal_apps_web. Owner explicitly requested no tests; none run. This is a live uncommitted template change: next deployment must preserve/integrate that link (git reset otherwise removes it). Static gallery is untracked on VPS. Template backup: /root/perf3-release/hub-before-design-reference.html. Gallery source: radar-design/mobile-gallery/index.html; images remain in probes/b-research-desk.png and b-direction/.
