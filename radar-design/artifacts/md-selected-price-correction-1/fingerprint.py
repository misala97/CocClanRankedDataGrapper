"""Candidate fingerprint for MD-SELECTED-PRICE-CORRECTION-1.

    py -3.12 radar-design/artifacts/md-selected-price-correction-1/fingerprint.py [--check-only] [--out NAME]
