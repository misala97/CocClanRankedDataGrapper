...
Since the one exercise list (2026-09-23) the copies name the same exercises
as the originals. The source's personal settings (step, rest, stack, bar)
stay behind: they describe the source's gym and habits.
"""
import argparse
import os
import sys
...
def copy_templates(source_username, destination_username, commit):
    """Copy source's templates to destination."""
