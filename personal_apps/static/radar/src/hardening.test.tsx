...
function payload(over: Partial<BoardPayload> = {}): BoardPayload {
  return {
    ...
    min_venues: 1, sort: null, dir: 'desc' as const, venue_counts: { any: 2, multi: 1 },
...
describe('what a failing status actually says', () => {
  ...
  const selection = {
    market: 'us' as const, sources: ['bluesky'], minVenues: 1, sort: null, dir: 'desc' as const,
    segments: [], window: 4,
  }
...
describe('a post nobody sized', () => {
  function post(over: Partial<Post> = {}): Post {
    return {
      ...
      url: null, tone: 'neutral', judged_by: null, judged_label: null, ...over,
    }
  }
